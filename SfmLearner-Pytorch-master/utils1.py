...
def save_path_formatter(args, parser):
    ...
    args_dict = vars(args)
    data_folder_name = str(Path(args_dict['dataset']).normpath().name)
...
def save_checkpoint_pose(save_path, exp_pose_state, is_best, filename='checkpoint.pth.tar'):
    torch.save(exp_pose_state, save_path/'{}_{}'.format("exp_pose", filename))
    if is_best:
        shutil.copyfile(save_path/'{}_{}'.format("exp_pose", filename), save_path/'{}_model_best.pth.tar'.format("exp_pose"))
