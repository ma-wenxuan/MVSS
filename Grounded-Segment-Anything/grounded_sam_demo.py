...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_image", type=str, default="assets/1.jpg", help="path to image file")
    ...
    for scene in range(41, 61):
        scene_path = os.path.join(saved_videos, f"scene{scene}")
        for frame in range(256):
            image_pil, image = load_image(image_path)
            image_pil.save(os.path.join(output_dir, "raw_image.png"))
            ...
            for i, obj in enumerate(masks, start=1):
                mask[obj[0].cpu().numpy()] = i * 10
