...
if __name__ == '__main__':
    ...
    root = '/home/mwx/AUBO_python3/saved_videos'
    ...
    writer = cv2.VideoWriter('result_4.mp4', fourcc, 5, (1280, 480))
    sample = dataset[0]
    ...
    out_label, out_label_refined, _ = test_sample(sample, network, network_crop)
    # for i in range(256*88, 256*89):
    for i in range(0, 256):
        ...
        out_label_n, out_label_refined_n,_ = test_sample(sample_n, network, network_crop)
        ...
        cv2.imwrite('./tmp/' + str(i) + '.jpg', img[:, 640:])
        writer.write(img)
