...
class SegNetwork(object):
    ...
    def forward(self, sample_i, sample_n):
        ...
        object_crops, object_embeddings = self.get_crop_embedding(rgb_crops_i, mask_crops_i, self.feature_extractor)
        ...
        object_crops, object_embeddings = self.get_crop_embedding(rgb_crops_n, mask_crops_n, self.feature_extractor)
