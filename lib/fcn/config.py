...
__C.TRAIN.EMBEDDING_LAMBDA_MVSS = 1.0
__C.TRAIN.EMBEDDING_LAMBDA_DENSE = 1.0
...
# __C.PIXEL_MEANS = np.array([[[133.9596, 132.5460,  71.7929]]])
__C.PIXEL_MEANS = np.array([[[126.0, 126.0, 126.0]]])
# For reproducibility
__C.RNG_SEED = 3
